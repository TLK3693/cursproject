...
<body class="bg-dark">
	...
	<div class="jumbotron text-center">
		<h2 class="display-4">Панель Админа</h2><hr>
			...
			<div class="col-sm-3 pt-4">
				<div class="card border border-info" style="background-color: white;">
					<div class="card-body text-center">
						...
						<p>---------------------------------------------</p>
						<p class="card-text">Разделы категорий здесь.</p>
						<a href="/admin/categories" class="card-link btn btn-primary">Изменить</a>
			...
			<div class="col-sm-3 pt-4">
				<div class="card" style="background-color: white;">
					<div class="card-body text-center">
						...
						<p>---------------------------------------------</p>
						<p class="card-text">Разделы продуктов здесь.</p>
						<a href="/admin/products" class="card-link btn btn-primary">Изменить</a>
			...
			<div class="col-sm-3 pt-4">
				<div class="card" style="background-color: white;">
					<div class="card-body text-center">
						...
						<p>---------------------------------------------</p>
						<p class="card-text">Разделы с пользователями здесь.</p>
						<a href="/admin/customers" class="card-link btn btn-primary">Изменить</a>
